...
ADAPTER_C_API_EXPORT void AdapterGetDefaultConfig(
    AdapterVisualizeConfig* config);

// Free strings allocated by the C library (JSON outputs or error messages)
ADAPTER_C_API_EXPORT void AdapterFreeString(char* str);

// Conversion functions
ADAPTER_C_API_EXPORT AdapterStatusCode AdapterConvertSavedModelToJson(
    const AdapterVisualizeConfig* config, const char* model_path,
    char** out_json, char** out_error_message);

ADAPTER_C_API_EXPORT AdapterStatusCode AdapterConvertFlatbufferToJson(
    const AdapterVisualizeConfig* config, const char* model_path,
    bool is_modelpath, char** out_json, char** out_error_message);

ADAPTER_C_API_EXPORT AdapterStatusCode AdapterConvertFlatbufferDirectlyToJson(
    const AdapterVisualizeConfig* config, const char* model_path,
    char** out_json, char** out_error_message);

ADAPTER_C_API_EXPORT AdapterStatusCode AdapterConvertSavedModelDirectlyToJson(
    const AdapterVisualizeConfig* config, const char* model_path,
    char** out_json, char** out_error_message);

ADAPTER_C_API_EXPORT AdapterStatusCode AdapterConvertGraphDefDirectlyToJson(
    const AdapterVisualizeConfig* config, const char* model_path,
    char** out_json, char** out_error_message);

ADAPTER_C_API_EXPORT AdapterStatusCode AdapterConvertMlirToJson(
    const AdapterVisualizeConfig* config, const char* model_path,
    char** out_json, char** out_error_message);
